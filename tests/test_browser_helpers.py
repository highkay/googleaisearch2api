...
def test_clean_answer_text_removes_standalone_source_labels_and_followup_tail() -> None:
    raw = """
台积电 3nm 等先进制程连续提价、AI 需求持续爆棚。
以下为您精选 5 条最核心的 A 股受益方向及代表股：
1. 晶圆代工（产能外溢与跟随提价）
代表股票：中芯国际 (688981)、华虹公司 (688347)。
新浪网
2. 半导体设备（扩产加速）
代表股票：中微公司 (688012)、北方华创 (002371)。
财联社
3. AI 芯片设计与 IP 授权
代表股票：寒武纪 (688256)、芯原股份 (688521)。
东方财富
如果您想深入了解，可以告诉我：
您更看重逻辑电路代工、半导体设备还是先进材料方向？
"""
